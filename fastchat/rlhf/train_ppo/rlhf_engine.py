...
from fastchat.rlhf.utils.ds_utils import get_train_ds_config, get_eval_ds_config
...
from fastchat.rlhf.utils.model.model_utils import create_hf_model, create_critic_model
from fastchat.rlhf.utils.utils import get_optimizer_grouped_parameters
"""
TODOs:
...
class DeepSpeedRLHFEngine():
    ...
    def _init_ref(self, actor_model_name_or_path):
        ...
        ref_model = create_hf_model(model_class=AutoModelForCausalLM,
                                    model_name_or_path=actor_model_name_or_path,
                                    tokenizer=self.tokenizer,
                                    ds_config=ds_config,
                                    trust_remote_code=True,
    ...
    def _init_ema(self, actor_model_name_or_path):
        ...
        actor_model_ema = create_hf_model(model_class=AutoModelForCausalLM,
                                    model_name_or_path=actor_model_name_or_path,
                                    tokenizer=self.tokenizer,
                                    ds_config=ds_config,
                                    trust_remote_code=True,
